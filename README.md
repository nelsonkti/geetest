...
Laravel Geetest is a package for Laravel  developed by [Nelsons](http://cuiqingcai.com). It provides simple usage for laravel of [Geetest](http://www.geetest.com/). 

Geetest Demo: [Geetest](https://www.geetest.com/show)

## Installation

Laravel 5 or later is required.

This Package now supports Geetest 3.1. 

For Geetest 2.0, please see [LaravelGeetest 2.0](https://github.com/Nelsons/LaravelGeetest/tree/v2.0.3)
...
you need to add  `Nelsons\Geetest\GeetestCaptcha` in your `AuthController`:

```php
use Nelsons\Geetest\GeetestCaptcha;
...
[Nelsons](http://nnn.com) , from Beijing China
